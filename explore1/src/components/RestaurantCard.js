...
//                 className="res-logo"
//                 alt="res-logo"
//                 src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_1024/d53b1f37316df558b222efcd039e9f73"
//              />
//             <h3>{ props.resName }</h3>
//             <h4>{ props.cuisine }</h4>
//             <h4>{ props.rating }</h4>
...
};   // inline styling using style={} using js object - not preferred
    ...
    return (
        <div className="res-card">
            ...
            <div className="rest-description">
                ...
                <div className="subtext">{ costForTwo }</div>
            </div>
        </div>
    )
};
